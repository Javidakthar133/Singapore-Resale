...
##-----------------------------------------------------------------Pickle--------------------------------------------------------------------------------------------#
with open(r"C:\Users\Javid Akthar\Desktop\Singapore Resale\sell.pkl",'rb') as file:
    price_model = pickle.load(file)
with open(r"C:\Users\Javid Akthar\Desktop\Singapore Resale\Cat_Columns_Encoded_value.json",'rb') as file:
...
background_image_url = "https://img.tepcdn.com/img-style/simplecrop_article/83444555.jpg"  
...
if selected =='Home':
    ...
    with col2:
        st.image('https://fastercapital.com/i/Pipeline-regression--How-to-perform-regression-analysis-on-your-pipeline-data-and-outputs--Training-and-Evaluating-the-Regression-Model.webp')
        st.image('https://wallstreetmojocms.recurpro.in/uploads/Random_Forest_07a645b1e3.png')
